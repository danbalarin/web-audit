...
Specifically, TBT quantifies the sum of all time periods between the [First Contentful Paint (FCP)](performance:first-contentful-paint) and the [Time to Interactive (TTI)](performance:time-to-interactive) where tasks exceed 50 milliseconds in duration.
