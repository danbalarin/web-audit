// window and document are defined by puppeteer
/* eslint-disable no-undef */
// SOURCE: https://github.com/tunetheweb/wappalyzer/blob/master/src/wappalyzer.js
...
class Site {
	...
	/**
	 * @returns {Promise<{urls: {[k: string]: {status: number}}, technologies:Array<{slug: String, name: String, description: String, confidence: Number, version: String, icon: String, website: String, cpe: String, categories: Array<{id: Number, slug: String, name: String}>}>>}
	 */
